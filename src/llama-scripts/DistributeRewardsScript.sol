...
contract DistributeRewardsScriptBase is LlamaBaseScript {
  ...
  function distributeOperatorRewards() external onlyDelegateCall {
    ...
    RIVER_TREASURY.transferERC20(
      LlamaAccount.ERC20Data({token: RVR_TOKEN, recipient: address(REGISTRY_DIAMOND), amount: totalAmount})
    );
...
contract DistributeRewardsScriptBaseSepolia is LlamaBaseScript {
  ...
  /// @dev The `RegistryDiamond` contract address.
  IRegistryDiamond internal constant REGISTRY_DIAMOND = IRegistryDiamond(0x08cC41b782F27d62995056a4EF2fCBAe0d3c266F);

  /// @dev The Treasury Llama account address.
  LlamaAccount internal constant RIVER_TREASURY = LlamaAccount(payable(0x8ee48C016b932A69779A25133b53F0fFf66C85C0));

  /// @dev The RVR ERC20 token address.
  IERC20 internal constant RVR_TOKEN = IERC20(0x49442708a16Bf7917764F14A2D103f40Eb27BdD8);
